...
var BootstrapDatepicker = function () {
    ...
    var demos = function () {
        ...
        // minimum setup for suimodal demo
        $('#m_datepicker_1_suimodal').datepicker({
            rtl: mUtil.isRTL(),
            todayHighlight: true,
            orientation: "bottom left",
            templates: arrows
        ...
        // input group layout for suimodal demo
        $('#m_datepicker_2_suimodal').datepicker({
            rtl: mUtil.isRTL(),
            todayHighlight: true,
            orientation: "bottom left",
            templates: arrows
        ...
        // enable clear button for suimodal demo
        $('#m_datepicker_3_suimodal').datepicker({
            rtl: mUtil.isRTL(),
            todayBtn: "linked",
            clearBtn: true,
            todayHighlight: true,
