...
var BlockUIDemo = function () {
    ...
    var demo4 = function () {
        ...
        $('#m_blockui_4_1').click(function() {
            mApp.block('#m_blockui_4_1_suimodal .suimodal-content', {});

            setTimeout(function() {
                mApp.unblock('#m_blockui_4_1_suimodal .suimodal-content');
            }, 2000);
        });

        $('#m_blockui_4_2').click(function() {
            mApp.block('#m_blockui_4_2_suimodal .suimodal-content', {
                overlayColor: '#000000',
                state: 'primary'
            });

            setTimeout(function() {
                mApp.unblock('#m_blockui_4_2_suimodal .suimodal-content');
            }, 2000);
        });

        $('#m_blockui_4_3').click(function() {
            mApp.block('#m_blockui_4_3_suimodal .suimodal-content', {
                overlayColor: '#000000',
                type: 'loader',
                state: 'success',
                size: 'lg'
            ...
            setTimeout(function() {
                mApp.unblock('#m_blockui_4_3_suimodal .suimodal-content');
            }, 2000);
        });

        $('#m_blockui_4_4').click(function() {
            mApp.block('#m_blockui_4_4_suimodal .suimodal-content', {
                overlayColor: '#000000',
                type: 'loader',
                state: 'success',
                message: 'Please wait...'
            ...
            setTimeout(function() {
                mApp.unblock('#m_blockui_4_4_suimodal .suimodal-content');
            }, 2000);
        });

        $('#m_blockui_4_5').click(function() {
            mApp.block('#m_blockui_4_5_suimodal .suimodal-content', {
                overlayColor: '#000000',
                type: 'loader',
                state: 'primary',
                message: 'Processing...'
            ...
            setTimeout(function() {
                mApp.unblock('#m_blockui_4_5_suimodal .suimodal-content');
            }, 2000);
        });
    }
